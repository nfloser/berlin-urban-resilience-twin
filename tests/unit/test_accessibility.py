...
from urban_resilience_twin.domain.models import (
    Coordinate, Disruption, DisruptionKind, Facility, FacilityType, RoadNode, RoadSegment, Scenario
)
...
def test_accessibility_comparison_reports_hospital_becoming_unreachable() -> None:
    ...
    hospital = Facility("H", "Hospital", FacilityType.HOSPITAL, Coordinate(52, 13.01), "D", "B")
    scenario = Scenario("s", "closure", (Disruption("d", DisruptionKind.ROAD_CLOSURE, ("AB",)),))
